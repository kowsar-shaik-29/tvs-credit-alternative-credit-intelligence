    ...
    def recommend_loan(
        ...
        if default_prob < 0.30 and affordability == "Comfortable":
            ...
            reasoning = (
                ...
                f"responsible debt-to-income profile. The proposed monthly EMI of ₹{est_emi:,.0f} absorbs well within monthly surplus."
            )
            ...
            reasoning = (
                ...
                f"but requested exposure is aligned to ₹{recommended_loan:,.0f} over {recommended_tenure} months to safeguard liquidity."
            )
        else:
            ...
            reasoning = (
                ...
                f"Adding a co-signer or pledged asset security can qualify applicant for higher financing."
            )
